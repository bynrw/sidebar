...
const subMenuItems = [
  {
    title: 'DZ/Karte',
    description: 'Dokumentationszentrale und Kartendarstellung',
    icon: <MapIcon fontSize="large" sx={{ color: 'secondary.main' }} />,
    path: '/auswertung/dz-karte',
    hasSubItems: false,
    borderStyle: { 
  ...
  {
    title: 'Suche',
    description: 'Erweiterte Suchoptionen',
...
const sucheSubMenuItems = [
  {
    title: 'Schadensort',
    description: 'Nach Schadensorten suchen',
    icon: <PlaceIcon fontSize="large" sx={{ color: 'secondary.main' }} />,
  ...
  {
    title: 'Ressourcen',
    description: 'Ressourcen durchsuchen',
    icon: <EngineeringIcon fontSize="large" sx={{ color: 'secondary.main' }} />,
  ...
  {
    title: 'NRW-Einheiten',
    description: 'Einheiten in NRW durchsuchen',
  ...
  {
    title: 'Sonstige',
    description: 'Sonstige Suchoptionen',
    icon: <MiscellaneousServicesIcon fontSize="large" sx={{ color: 'secondary.main' }} />,
  ...
  {
    title: 'Krankenhäuser',
    description: 'Krankenhäuser durchsuchen',
  ...
  {
    title: 'Organisation',
    description: 'Nach Organisationen suchen',
  ...
  {
    title: 'Sirenen',
    description: 'Sirenendaten durchsuchen',
