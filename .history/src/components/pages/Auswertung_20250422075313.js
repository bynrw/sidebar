...
const subMenuItems = [
  {
    title: 'DZ/Karte',
    description: 'Digitale Karten und Einsatzübersicht',
    icon: <MapIcon fontSize="large" sx={{ color: 'secondary.main' }} />,
    path: '/auswertung/karte',
    hasSubItems: false,
    borderStyle: { 
  ...
  {
    title: 'Suche',
    description: 'Suche in verschiedenen Kategorien',
...
const sucheSubMenuItems = [
  ...
  {
    title: 'Ressourcen',
    description: 'Suche nach verfügbaren Ressourcen',
  ...
  {
    title: 'NRW-Einheiten',
    description: 'Suche nach Einheiten in NRW',
  ...
  {
    title: 'Sonstige',
    description: 'Weitere Suchoptionen',
  ...
  {
    title: 'Sirenen',
    description: 'Suche nach Sirenenstandorten',
