        ...
        >
          <Toolbar sx={{ 
            ...
            <Box sx={{ 
              ...
              {/* Notifications with enhanced animation and styling */}
              <Tooltip 
              ...
              >
                <IconButton
                  ...
                  sx={{ 
                    position: 'relative',
                    ml: 0.5,
                    backgroundColor: Boolean(notificationAnchorEl) ? 'rgba(25, 118, 210, 0.15)' : 'rgba(0,0,0,0.03)',
                    '&:hover': {
                      backgroundColor: 'rgba(25, 118, 210, 0.1)',
                      transform: 'translateY(-2px)',
                      boxShadow: '0 3px 10px rgba(25, 118, 210, 0.15)'
                    ...
                    '&::after': {
                      content: '""',
                      position: 'absolute',
                      inset: Boolean(notificationAnchorEl) ? -4 : -2,
                      border: `2px solid ${Boolean(notificationAnchorEl) ? 'rgba(25, 118, 210, 0.5)' : 'transparent'}`,
                      borderRadius: '50%',
                      transition: 'all 0.3s'
                    },
                    '&:hover::after': {
                    ...
                    sx={{
                      '& .MuiBadge-badge': {
                        ...
                        '@keyframes pulseBadge': {
                          ...
                          '50%': { transform: 'scale(1.1)', boxShadow: '0 0 0 5px rgba(211, 47, 47, 0)' },
