...
const menuItems = [
  ...
  },
  {
    ...
    icon: <GroupsIcon />,
    path: '/benutzerbestand',
    color: 'primary',
    description: 'Verwaltung des Benutzerbestands',
    subMenu: [
      {
        title: 'Liste',
        path: '/benutzerbestand/liste'
      },
      {
        title: 'Neuer Benutzer',
        path: '/benutzerbestand/neuer-benutzer'
      }
    ]
  },
  {
    ...
    icon: <BusinessIcon />,
    path: '/organisationsdaten',
    color: 'warning',
    description: 'Organisationsdaten verwalten',
    subMenu: [
      {
        title: 'Datenbearbeiten',
        path: '/organisationsdaten/datenbearbeiten'
      }
    ]
  },
  {
