  ...
  return (
    <ExpandedMenuContext.Provider value={{ expandedMenus, setExpandedMenus }}>
      <Box sx={{ display: 'flex', height: '100vh' }}>
        ...
        >
          <Toolbar sx={{ display: 'flex', justifyContent: 'space-between', minHeight: { xs: '60px', sm: '64px' } }}>
            ...
            <Box sx={{ display: 'flex', alignItems: 'center' }}>
              ...
              >
                <Box component="span" sx={{ 
                  background: 'linear-gradient(45deg, #004c8c 30%, #0277bd 90%)',
            ...
            {/* Center section: Dynamic path indicators with animated transitions */}
            <Box 
              sx={{ 
            ...
            {/* Right side: Tools and quick actions with modern tooltips */}
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.7 }}>
              {/* Search Button with active animation */}
              <Tooltip 
                title="Suchen" 
                arrow
                componentsProps={{
              ...
              {/* Notifications with count indicator */}
              <Tooltip 
              ...
              >
                <IconButton
                  ...
                  sx={{ 
                    position: 'relative',
                    ml: 0.5,
                    backgroundColor: Boolean(notificationAnchorEl) ? 'rgba(25, 118, 210, 0.12)' : 'rgba(0,0,0,0.04)',
                    '&:hover': {
                      backgroundColor: 'rgba(25, 118, 210, 0.08)',
                      transform: 'translateY(-2px)'
                    },
              ...
              {/* Dark Mode Toggle with visually creative animation */}
              <Tooltip 
                  ...
                  <Box sx={{ 
                    ...
                    {darkMode ? (
                      <Brightness7Icon 
                        sx={{ 
                          position: 'absolute',
                          animation: 'fadeInRotate 0.3s forwards',
              ...
              {/* User Profile with personal avatar */}
              <Tooltip 
              ...
              >
                <IconButton 
                  ...
                  sx={{ 
                    ml: 0.5, 
                    backgroundColor: Boolean(anchorEl) ? 'rgba(25, 118, 210, 0.12)' : 'rgba(0,0,0,0.04)',
                    '&:hover': {
                      backgroundColor: 'rgba(25, 118, 210, 0.08)',
                      transform: 'translateY(-2px)'
                    },
