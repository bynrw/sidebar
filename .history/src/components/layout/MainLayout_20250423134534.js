        ...
        <Box sx={{ 
          ...
          {favorites && favorites.favorites && favorites.favorites.map((favorite, index) => (
            <Chip
              ...
              sx={{ 
                ...
                border: '1px solid',
                borderColor: favorite.accentColor + '50',
                backgroundColor: isActive(favorite.path) ? `${favorite.accentColor}20` : 'transparent',
                color: isActive(favorite.path) ? favorite.accentColor : 'text.primary',
                fontWeight: isActive(favorite.path) ? 'medium' : 'normal',
                '& .MuiChip-icon': {
                  color: isActive(favorite.path) ? favorite.accentColor : 'text.secondary',
                  fontSize: '16px',
                  marginLeft: 0.5,
                  marginRight: -0.5
                },
                ...
                '&:hover': {
                  ...
                  boxShadow: `0 4px 8px ${favorite.accentColor}20`,
                ...
                animation: isActive(favorite.path) ? 
                  'glow 1.5s infinite alternate' : 'none',
                '@keyframes glow': {
                  '0%': { boxShadow: '0 0 2px rgba(0,0,0,0)' },
                  '100%': { boxShadow: `0 0 8px ${favorite.accentColor}60` }
                }
              }}
            />
          ))}
          ...
          {(!favorites || !favorites.favorites || favorites.favorites.length === 0) && (
            <Box sx={{ 
              ...
              px: 1,
              borderRadius: 2,
              backgroundImage: `linear-gradient(135deg, ${theme.palette.background.paper} 25%, ${theme.palette.background.default} 25%, ${theme.palette.background.default} 50%, ${theme.palette.background.paper} 50%, ${theme.palette.background.paper} 75%, ${theme.palette.background.default} 75%, ${theme.palette.background.default} 100%)`,
