...
const menuItems = [
  {
    ...
    path: '/medirig', // Changed from /erfassung/medirig to /medirig
    color: 'medical',
  ...
  return (
    <Box sx={{ display: 'flex', height: '100vh' }}>
        ...
        <Collapse in={showLiveticker}>
          ...
          >
            ...
            <Box sx={{ 
              ...
              {/* User information display when ticker is active */}
              <Box sx={{ 
                display: 'flex', 
                alignItems: 'center', 
                mr: 2, 
      ...
      <Box
        ...
        sx={{
          flexGrow: 1,
          // Adjust padding when ticker is active to prevent overlap with content
          pt: { 
            xs: showLiveticker ? 14 : 7,  // Additional spacing when ticker is active
            sm: showLiveticker ? 15 : 8   // Additional spacing when ticker is active
          },
          height: '100vh',
          overflow: 'auto',
