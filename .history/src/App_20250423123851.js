...
function App() {
  ...
  // Helper-Funktion zum Prüfen, ob ein Item ein Favorit ist
  const isFavorite = (item) => {
    return favorites.some(fav => fav.title === item.title && fav.path === item.path);
  };
  ...
  // Das aktuelle Theme basierend auf dem Dark Mode
